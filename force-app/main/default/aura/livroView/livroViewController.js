({
    ...
    init: function (component, event, helper) {
        ...
        component.set('v.columns', [
            ...
            { label: 'Quantidade Disp. Auto.', fieldName: 'QuantidadeDisponivelAutomatica__c', type: 'number' },
            ...
            case 'show_details':
                ...
                actionSearch.setCallback(this, function (response) {
                    ...
                    if (stateSearch == 'SUCCESS') {
                        ...
                        component.set('v.quantidadeDisponivelAutomatica', returnValue.QuantidadeDisponivelAutomatica__c);
                    }
                });
    ...
    showModal: function (component, event, helper) {
        ...
        component.set('v.quantidadeDisponivelAutomatica', null);
